...
//    var ws = new WebSocket('ws://' + 'giannini.homeip.net' + ':9999');
    var ws = new WebSocket('ws://' + '192.168.1.103' + ':9999');
	...
	move(amperometro,A);move(voltmetro,V);move(wattmetro,W);move(pressostato,Bar);move(pressostato_pozzo,Bar_pozzo);
